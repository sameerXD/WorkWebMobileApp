...
export const BottomTabs = () => {
  return (
    <Tab.Navigator
      ...
      <Tab.Screen
        options={{
          tabBarIcon: () => <Home size={30} color={'#B4B4B8'} name="home" />,
          tabBarStyle: {paddingBottom: '2.5%', height: '7.5%'},
        }}
        name="Home"
      ...
      <Tab.Screen
        options={{
          tabBarIcon: () => (
            <DocumetIcon size={30} color={'#B4B4B8'} name="copy1" />
          ),
        }}
        name="Documents"
        component={HomeScreen}
      ...
      <Tab.Screen
        options={{
          tabBarIcon: () => (
            <Icon size={30} color={'#B4B4B8'} name="holiday-village" />
          ),
        }}
        name="Leaves"
      ...
      <Tab.Screen
        options={{
          tabBarIcon: () => <Home size={30} color={'#B4B4B8'} name="user" />,
        }}
        name="Profile"
